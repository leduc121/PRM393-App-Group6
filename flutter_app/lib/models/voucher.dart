class Voucher {
  ...
  factory Voucher.fromJson(Map<String, dynamic> json) {
    return Voucher(
      id: (json['voucherId'] ?? json['voucher_id'] ?? json['id'] ?? '')
          .toString(),
      code: json['code']?.toString() ?? '',
      description: json['description']?.toString(),
      discountType:
          (json['discountType'] ?? json['discount_type'] ?? 'fixed_amount')
              .toString(),
      ...
      targetTier: (json['targetTier'] ?? json['target_tier'] ?? 'bronze')
          .toString(),
  ...
  String get discountDisplay {
    if (discountType == 'percentage') {
      final extra = maxDiscount != null
          ? ' (max ${_formatVnd(maxDiscount!)})'
          : '';
  ...
  int calculateDiscount(int subtotal) {
    ...
    if (discountType == 'percentage') {
      ...
      if (maxDiscount != null) {
        amount = amount < maxDiscount! ? amount : maxDiscount!;
      }
